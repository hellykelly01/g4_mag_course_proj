...
int main(int argc, char* argv[]){
  ...
  AI->RegisterPrimaryGeneratorAction(new UniformPrimaryGeneratorAction("e+", 3 * MeV));
  RunAction* RA = new RunAction("/home/lev/geant4/my_projects/mag_course_proj/positron/output/uniform_generation.root");
